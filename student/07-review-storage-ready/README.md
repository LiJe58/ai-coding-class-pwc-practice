...
Agent 조서 파일 `output/day-2/working-paper.json`을 보존하고 Day 3 SQLite는 실행 중에만 사용하세요. 문제 발생 시 `python scripts/checkpoint.py reset student/07-review-storage-ready`로 복구합니다.
